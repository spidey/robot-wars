...
try:
    ...
    while True:
        ...
        print(f"LdrSersorLeftValue is {LdrSersorLeftValue}")
        print(f"LdrSersorRightValue is {LdrSersorRightValue}")

        if LdrSersorLeftValue == True or LdrSersorRightValue == True:
            brake()
        else:
            run()
